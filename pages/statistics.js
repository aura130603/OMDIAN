    ...
    <div className="dashboard-container">
      ...
      <div className="container">
        <div className="dashboard-content">
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                ...
                {user.role === 'admin' && (
                  <div style={{ display: 'flex', gap: '10px' }}>
                    <button className="btn btn-small" onClick={handleExportEmployeeReport}>
                      📊 Download Data Pegawai
                    </button>
                    <button className="btn btn-small" onClick={handleExportTrainingReport}>
                      📈 Download Data Pelatihan
                    </button>
          ...
          {/* ini ada card yang dihapus, aku taruh di README YAA */}
